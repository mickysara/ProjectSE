...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2019 at 04:05 PM
...
CREATE TABLE `assessment` (
  ...
  `average` double(20,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `assessment` (`AssessmentID`, `UserID`, `result`, `total`, `count`, `average`, `EvaluationID`, `EvaluationFormID`, `DepartmentID`) VALUES
(23, 3, '[\"3\",\"1\"]', 4, 2, 2.00, 3, 1, 1),
(24, 1, '[\"4\",\"2\"]', 6, 2, 3.00, 3, 1, 2),
(25, 8, '[\"4\",\"4\"]', 8, 2, 4.00, 3, 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `departinevaluation`
--

CREATE TABLE `departinevaluation` (
...
--
-- Dumping data for table `departinevaluation`
--

INSERT INTO `departinevaluation` (`ID_DE`, `DepartmentID`, `EvaluationID`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 2, 3),
(4, 1, 3);
...
CREATE TABLE `department` (
  `DepartmentID` smallint(5) NOT NULL,
  `DepartmentName` varchar(100) NOT NULL,
  `ReferenceCode` smallint(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `department` (`DepartmentID`, `DepartmentName`, `ReferenceCode`) VALUES
(1, 'วิทยาเขตจักพงษ์ภูวนารถ สาขาวิทย์คอม', 123),
(2, 'วิทยาเขตบางพระ', 999);
...
INSERT INTO `evaluation` (`EvaluationID`, `EvaluationName`, `Year`, `StartDate`, `FinalDate`, `TrainingID`) VALUES
(1, 'การประเมินความสะอาดในมหาวิทยาลัย', 2562, '2019-04-26', '2019-04-30', 1),
(2, 'การประเมิน', 2561, '2019-04-22', '2019-04-29', 2),
(3, 'การประเมินห้องครัว', 2562, '2019-04-22', '2019-04-29', 3);
...
CREATE TABLE `evaluationform` (
  `EvaluationFormID` int(10) NOT NULL,
  `EvaluationformName` text NOT NULL,
  `EvaluationID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `evaluationform` (`EvaluationFormID`, `EvaluationformName`, `EvaluationID`) VALUES
(1, 'ความสะอาดในห้องน้ำบริเวณอาคารเรียน5', 1),
(2, 'ความสะอาดในห้องน้ำบริเวณอาคารเรียน5', 1),
(3, 'กวาดห้อง1', 2),
(4, 'กวาดห้องน้ำ', 2),
(5, 'ผ', 1),
(6, '111', 2),
(7, 'ความสะอาดบริเวณซิ้งค์ล้างจาน', 3),
(8, 'ความสะอาดบริเวณเตาอบ', 3);
...
CREATE TABLE `participant` (
  `ParticipatedID` int(10) NOT NULL,
...
CREATE TABLE `training` (
  ...
  `TrainingDetailID` text NOT NULL,
  `StartDate` date NOT NULL,
  `FinalDate` date NOT NULL,
  `Lecturer` varchar(100) NOT NULL,
  `Expenditure` float(10,2) NOT NULL,
...
INSERT INTO `training` (`TrainingID`, `TrainingName`, `TrainingDetailID`, `StartDate`, `FinalDate`, `Lecturer`, `Expenditure`, `Place`, `Amount`) VALUES
(1, 'การอบรมความสะอาดมหาวิทยาลัย', 'การอบรมความสะอาดมหาวิทยาลัย', '2019-04-19', '2019-04-20', 'นายเมธา ฟ้าแว๊บๆ', 1000.00, 'ห้อง VIP5', 100),
(2, 'การอบรม TQF', 'T = Traidition', '2019-04-22', '2019-04-22', 'อ.ส้ม', 150000.00, 'ห้องประชานารถ', 25),
(3, 'การอบรมจุ๊บ', 'จุ๊ลหลายที', '2019-04-22', '2019-04-29', 'หารมโหรี', 50000000.00, 'ห้องครัว', 1);
...
INSERT INTO `users` (`UserID`, `Email`, `Password`, `IdentityNumber`, `FirstName`, `LastName`, `Address`, `Telephone`, `TypeID`, `DepartmentID`, `Expertise`) VALUES
(1, 'test@gmail.com', 'asd', '1129900426611', 'asd', 'asd', 'asd', '0873428415', 1, 1, 'asdasd'),
(2, 'test5@gmail.com', 'asd', '1129900426611', 'asd', 'asd', '1707', '0873428415', 1, 1, 'asdasd'),
(3, 'admin@gmail.com', '1234', '1129900426611', 'Nitipong ', 'Sarasri', '99/533', '0873428415', 2, 1, 'asdasdasdasd'),
(4, 'test3@gmail.com', 'asd', '1129900426611', 'นิติพงษ์ ', 'สารศรี', '1544', '0873428415', 1, 1, 'โปรแกรมมิ่ง'),
(6, 'zack@gmail.com', '1111', '1111111111111', 'z', 'z', '222', '0999999999', 1, 1, 'godz'),
(7, 'aa@gmail.com', '1111', '1111111111111', 'asd', 'asd', '222', '0999999999', 1, 2, 'โปรแกรมมิ่ง'),
(8, 'a@gmail.com', '1234', '1129900426611', 'a', 'a', '314', '0123456789', 1, 1, 'โปรแกรมมิ่ง');
...
ALTER TABLE `assessment`
  ...
  ADD KEY `EvaluationFormID` (`EvaluationFormID`);

--
-- Indexes for table `departinevaluation`
--
ALTER TABLE `departinevaluation`
...
ALTER TABLE `evaluation`
  ...
  ADD KEY `EvaluationFormID` (`TrainingID`),
...
ALTER TABLE `participant`
  ADD PRIMARY KEY (`ParticipatedID`),
  ADD KEY `UserID` (`UserID`),
  ADD KEY `TrainingID` (`TrainingID`);
...
ALTER TABLE `users`
  ...
  ADD KEY `TypeID` (`TypeID`,`DepartmentID`),
  ADD KEY `DepartmentID` (`DepartmentID`);
...
--
-- AUTO_INCREMENT for table `departinevaluation`
--
ALTER TABLE `departinevaluation`
  MODIFY `ID_DE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `department`
--
ALTER TABLE `department`
  MODIFY `DepartmentID` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `evaluation`
--
ALTER TABLE `evaluation`
  MODIFY `EvaluationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `evaluationform`
--
ALTER TABLE `evaluationform`
  MODIFY `EvaluationFormID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `training`
  MODIFY `TrainingID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `usertype`
  MODIFY `TypeID` tinyint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `departinevaluation`
--
ALTER TABLE `departinevaluation`
  ADD CONSTRAINT `departinevaluation_ibfk_1` FOREIGN KEY (`DepartmentID`) REFERENCES `department` (`DepartmentID`),
  ADD CONSTRAINT `departinevaluation_ibfk_2` FOREIGN KEY (`EvaluationID`) REFERENCES `evaluation` (`EvaluationID`);

--
-- Constraints for table `evaluation`
--
ALTER TABLE `evaluation`
  ADD CONSTRAINT `evaluation_ibfk_1` FOREIGN KEY (`TrainingID`) REFERENCES `training` (`TrainingID`);

--
-- Constraints for table `evaluationform`
--
ALTER TABLE `evaluationform`
  ADD CONSTRAINT `evaluationform_ibfk_2` FOREIGN KEY (`EvaluationID`) REFERENCES `evaluation` (`EvaluationID`);

--
-- Constraints for table `participant`
--
ALTER TABLE `participant`
  ADD CONSTRAINT `participant_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`),
  ADD CONSTRAINT `participant_ibfk_2` FOREIGN KEY (`TrainingID`) REFERENCES `training` (`TrainingID`);
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`TypeID`) REFERENCES `usertype` (`TypeID`);
COMMIT;
